 ...
 * @author Seven
 */
public class Explossao2 extends AbilidadeMapa {

    public int contador;
    public final int DELAY = 30;

    public Explossao2(int posX, int posY) {
    ...
    public void render(Graphics2D g) {
        ...
        if (contador < 10) {
            ...
            img = ImageManager.getInstance().getImageAbilidade(3, 0, 0, 20, 19);
            g.drawImage(img, (int) pos.x, (int) pos.y, null);
        } else if (contador < 20) {
            //g.setComposite(AlphaComposite.getInstance(AlphaComposite.SRC_OVER, 0.5f));
            img = ImageManager.getInstance().getImageAbilidade(3, 20, 0, 20, 19);
            g.drawImage(img, (int) pos.x, (int) pos.y, null);
        } else {
            //g.setComposite(AlphaComposite.getInstance(AlphaComposite.SRC_OVER, 0.5f));
            img = ImageManager.getInstance().getImageAbilidade(3, 40, 0, 20, 19);
            g.drawImage(img, (int) pos.x, (int) pos.y, null);
        }
